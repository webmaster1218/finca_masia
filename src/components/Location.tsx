        ...
        <section id="ubicacion" className="py-24 md:py-32 px-6 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                    ...
                    >
                        <div className="p-10 bg-[#FAF8F2] shadow-2xl border-l-4 border-[#1a3c34] relative overflow-hidden text-[#1a3c34]">
                            <div className="relative z-10">
                                ...
                                <div className="space-y-6 text-[#1a3c34]/80 font-serif">
                                    <div className="flex gap-4">
                                        <MapPin className="w-6 h-6 text-[#1a3c34] shrink-0" />
                                        <div>
                                    ...
                                    <div className="flex gap-4">
                                        <Navigation className="w-6 h-6 text-[#1a3c34] shrink-0" />
                                        <div>
                                            <p className="font-bold text-[#1a3c34]">{t('location.ref_label')}</p>
                                            <p className="text-sm whitespace-pre-line">{t('location.ref_val')}</p>
                                        </div>
                                    </div>
                                </div>

                                <div className="mt-10 pt-10 border-t border-[#1a3c34]/10">
                                    <a
                                        href="https://www.google.com/maps?q=6.127667,-75.414250"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="inline-flex items-center gap-3 px-8 py-4 bg-[#1a3c34] text-white font-serif hover:bg-[#2a4d45] transition-all duration-500 group"
                                    >
                    ...
                    >
                        <iframe
                            src="https://maps.google.com/maps?q=6.127667,-75.414250&t=&z=15&ie=UTF8&iwloc=&output=embed"
                            width="100%"
                            height="100%"
                            style={{ border: 0 }}
                            allowFullScreen
                        ...
                        <div className="absolute inset-0 pointer-events-none border-[12px] border-[#1a3c34]/10" />
                    </motion.div>
                </div>
            </div>
        </section>
